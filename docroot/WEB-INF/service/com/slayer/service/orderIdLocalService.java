...
/**
 * Provides the local service interface for orderId. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nithesh
 * @see orderIdLocalServiceUtil
...
public interface orderIdLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link orderIdLocalServiceUtil} to access the order ID local service. Add custom service methods to {@link com.slayer.service.impl.orderIdLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
